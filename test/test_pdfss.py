...
def _relayout(filename):
    ...
    for group in pdfss.relayout(
        ...
        for line in group:
            group_result.append([text_group.text for text_group in line.blocks])
    ...
    def test_edf_c1_10074973936_p5(self):
        ...
        self.assertEqual(
            ...
            [
                ...
                [
                    ["Données de comptage", "Puissance(s) souscrite(s) (kW ou kVA)"],
                    [
        ...
        self.assertEqual(
            ...
            [
                ...
                [
                    ...
                    ["Prix non réglementés", "Info. site personnalisée : 3795-SIP"],
    ...
    def test_edf_c2_10067224248_p5(self):
        ...
        self.assertEqual(
            ...
            [
                ...
                [
                    ["Site : USINE", "Code site :", "1311EP303802277I016"],
                ...
                [["Période", "Index de début", "Index de fin", "Puissance atteinte"]],
                [["(kW ou kVA)"]],
                [
                    ["Pointe", "22222 le 01/09/2017", "22222 le 30/09/2017", "0"],
                    [
                        "Heures Pleines Hiver",
                        "79756 le 01/09/2017",
                        "79756 le 30/09/2017",
                    ...
                    [
                        "Heures Pleines Eté",
                        "938818 le 01/09/2017",
                        "1142600 le 30/09/2017",
                        "653",
                    ],
                    [
                        "Heures Creuses Eté",
                        "672004 le 01/09/2017",
                        "821002 le 30/09/2017",
                        "608",
                    ],
                ],
